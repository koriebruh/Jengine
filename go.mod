module github.com/koriebruh/Jengine

// plans/docs/00-overview-and-architecture.md §1.3 targets Go 1.23+.
// GOTOOLCHAIN=auto bumped this to 1.25.0 to satisfy a transitive dependency
// (testcontainers-go, added by plans/task/core/17) - exceeds the 1.23+
