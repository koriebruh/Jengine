...
const (
	...
	TransactionServiceName = "jengine.v1.TransactionService"
)
...
const (
	...
	// GetTransaction RPC.
	TransactionServiceGetTransactionProcedure = "/jengine.v1.TransactionService/GetTransaction"
	// TransactionServiceListTransactionsProcedure is the fully-qualified name of the
	// TransactionService's ListTransactions RPC.
	TransactionServiceListTransactionsProcedure = "/jengine.v1.TransactionService/ListTransactions"
)

// TransactionServiceClient is a client for the jengine.v1.TransactionService service.
...
// NewTransactionServiceClient constructs a client for the jengine.v1.TransactionService service. By
...
func NewTransactionServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TransactionServiceClient {
	...
	transactionServiceMethods := v1.File_jengine_v1_transaction_proto.Services().ByName("TransactionService").Methods()
...
// GetTransaction calls jengine.v1.TransactionService.GetTransaction.
...
// ListTransactions calls jengine.v1.TransactionService.ListTransactions.
...
// TransactionServiceHandler is an implementation of the jengine.v1.TransactionService service.
...
func NewTransactionServiceHandler(svc TransactionServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/jengine.v1.TransactionService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTransactionServiceHandler) GetTransaction(context.Context, *connect.Request[v1.GetTransactionRequest]) (*connect.Response[v1.GetTransactionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("jengine.v1.TransactionService.GetTransaction is not implemented"))
}
...
func (UnimplementedTransactionServiceHandler) ListTransactions(context.Context, *connect.Request[v1.ListTransactionsRequest]) (*connect.Response[v1.ListTransactionsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("jengine.v1.TransactionService.ListTransactions is not implemented"))
}
