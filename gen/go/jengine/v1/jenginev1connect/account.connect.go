...
const (
	...
	AccountServiceName = "jengine.v1.AccountService"
)
...
const (
	...
	// CreateAccount RPC.
	AccountServiceCreateAccountProcedure = "/jengine.v1.AccountService/CreateAccount"
	// AccountServiceGetAccountProcedure is the fully-qualified name of the AccountService's GetAccount
	// RPC.
	AccountServiceGetAccountProcedure = "/jengine.v1.AccountService/GetAccount"
	// AccountServiceListAccountsProcedure is the fully-qualified name of the AccountService's
	// ListAccounts RPC.
	AccountServiceListAccountsProcedure = "/jengine.v1.AccountService/ListAccounts"
)

// AccountServiceClient is a client for the jengine.v1.AccountService service.
...
// NewAccountServiceClient constructs a client for the jengine.v1.AccountService service. By
...
func NewAccountServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AccountServiceClient {
	...
	accountServiceMethods := v1.File_jengine_v1_account_proto.Services().ByName("AccountService").Methods()
...
// CreateAccount calls jengine.v1.AccountService.CreateAccount.
...
// GetAccount calls jengine.v1.AccountService.GetAccount.
...
// ListAccounts calls jengine.v1.AccountService.ListAccounts.
...
// AccountServiceHandler is an implementation of the jengine.v1.AccountService service.
...
func NewAccountServiceHandler(svc AccountServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/jengine.v1.AccountService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAccountServiceHandler) CreateAccount(context.Context, *connect.Request[v1.CreateAccountRequest]) (*connect.Response[v1.CreateAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("jengine.v1.AccountService.CreateAccount is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) GetAccount(context.Context, *connect.Request[v1.GetAccountRequest]) (*connect.Response[v1.GetAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("jengine.v1.AccountService.GetAccount is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) ListAccounts(context.Context, *connect.Request[v1.ListAccountsRequest]) (*connect.Response[v1.ListAccountsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("jengine.v1.AccountService.ListAccounts is not implemented"))
}
